const afiliadoResolver = {
    Query: {
        afiliadoByIdentificacion: async (_, {identificacion}, {dataSources, autenticado}) => {
            if (autenticado == true) {
                return await dataSources.afiliadoAPI.afiliadoByIdentificacion(identificacion);
              } else {
                return null;
              }
        },
    ...
    Mutation: {
        ...
        deleteAfiliado: async (_, {identificacion}, {dataSources, autenticado}) => {
            if (autenticado == true) {
